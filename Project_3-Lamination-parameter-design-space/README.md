...
- CONTOUR MAPPING FOR COMPRESSION BUCKLING
    ...
    <em><strong>Figure 4.</strong> Compression buckling contours map construction for $a/b$ = 2.0, involving superposition of contour maps for each buckling mode, representing $m$ = 1, 2, 3 and 4 in Eqn. \ref{eq:bucklingCFS}. Shading illustrates the extent of each mode region, corresponding to minimum $k_x$.</em>
