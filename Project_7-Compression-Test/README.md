...
The measured values of the manufactured laminates are shown in Table \ref{Table:ExpSpecimenDimensions}, where DD, ES, BS and ISO represent the double angle-ply, <em>Extension-Shear coupled</em>, balance and symmetric and fully isotropic designs. 
